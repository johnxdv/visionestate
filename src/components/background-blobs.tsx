/**
 * Nappe d'ambiance fixe : trois masses beige floutées qui dérivent sur
 * des trajets désaccordés, et une grille de points fine par-dessus.
 * Seul `transform` est animé — le flou est rasterisé une fois.
 */
export function BackgroundBlobs() {
  return (
    ...
    >
      ...
      {/* Au-dessus des blobs : la trame reste lisible là où le beige
          s'épaissit. */}
